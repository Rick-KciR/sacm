...
class Evento:
    ...
    def __init__(self, nome, data, local, capacidadeMaxima, descricao):
        self.idEvento = len(eventos) + 1 # a cada instancia, o tamanho da lista é usado para incrementar o id
        self.nome = nome
        self.data = data
        self.local = local
...
class Inscricao:
    ...
    def __init__(self, evento, participante):
        ...
        for insc in inscricoes:
           """
            verifica se o participante/idParticipante em inscrição é igual ao participante/idParticipante e
            se o evento no qual se inscreveu, insc.evento.idEvento, é igual a evento.idEvento
        ...
        self.evento = evento # o argumento "evento" é um objeto de Evento recebido durante a inscrição
...
#for percorre a essa lsita de participantes
for p in [participante1, participante2, participante3, participante4, participante5]:
    # nesse trecho cria-se chave e valor no dicionário participantes
    # na primeira iteração, na posição p (0), toma-se o id do participante como chave 
